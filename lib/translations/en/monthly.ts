...
export const monthlyDetail = {
  ...
  retrospectiveTab: {
    keyResultsStatus: "Key Results Status",
    completedKeyResults: "Completed Key Results ({completed}/{total})",
    failedKeyResults: "Failed Key Results ({failed}/{total})",
    keyResultProgress: "Target: {target} → Achieved: {completed}",
    noKeyResults: "No key results set.",
    stuckPoints: "Stuck Points",
    newLearnings: "New Learnings",
    memorableTask: "Most Memorable Task",
    failedKeyResultsAnalysis: "Failed Key Results Analysis",
  },
  note: {
  ...
  retrospectiveForm: {
    ...
    keyResultsReviewPlaceholder:
      "Evaluate the key results of this monthly overall",
