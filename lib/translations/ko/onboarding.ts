export const onboarding = {
  ...
  para: "PARA 시스템",
  paraDesc: "목표를 실행하기 위한 프로젝트, 영역, 자원을 체계적으로 관리합니다",
  game: "게임형 자기관리",
  ...
  progressDesc: "목표 달성률과 남은 기간을 한눈에 확인",
  todayTasks: "오늘의 할 일",
  ...
  // 에러 메시지
  errorTitle: "오류 발생",
  errorDescription: "앱 사용법 완료 처리 중 문제가 발생했습니다.",
