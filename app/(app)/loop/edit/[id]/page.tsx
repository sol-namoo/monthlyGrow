  ...
  return (
    <div className="container max-w-md px-4 py-6">
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          루프 제목과 보상은 언제든지 수정할 수 있습니다. 중점 Areas는 루프 시작 후 3일 이내에만 수정 가능합니다.
          시작일과 종료일은 수정할 수 없습니다.
        </AlertDescription>
      </Alert>
      ...
      <form onSubmit={handleSubmit}>
        <Card className="mb-6 p-4">
          ...
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-muted-foreground">루프 기간은 수정할 수 없습니다.</p>
          </div>
        </Card>
        ...
        <Card className="mb-6 p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {loop.areas.map((area, index) => (
              <Badge key={index} variant="secondary" className={!canEditAreas ? "opacity-70" : ""}>
                {area}
              </Badge>
            ))}
          </div>
        ...
        <Card className="mb-6 p-4">
          ...
          <div className="mt-4">
            <Button variant="outline" size="sm" asChild className="w-full">
              <Link href={`/loop/${loopId}/add-project`}>프로젝트 추가/제거</Link>
            </Button>
          </div>
        </Card>
